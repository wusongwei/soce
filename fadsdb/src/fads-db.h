...
namespace fadsdb{
    ...
    public:
        ...
        FadsDbRespStatus insert(const std::string& table,
                                const std::string& key,
                                const char* data,
                                size_t len);
        FadsDbRespStatus remove(const std::string& table, const std::string& key);
        FadsDbRespStatus update(const std::string& table,
                                const std::string& key,
                                const std::string& cmd,
                                const std::string& filters);
        FadsDbRespStatus select(const std::string& table,
                                const std::string& key,
                                const std::string& fields,
                                const std::string& filters,
                                std::string& out);
        FadsDbRespStatus selup(const std::string& table,
                               const std::string& key,
                               const std::string& fields,
