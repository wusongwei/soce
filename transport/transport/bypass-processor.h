...
#ifndef _BYPASS_PROCESSOR_vzSpKiJIIy_H_
#define _BYPASS_PROCESSOR_vzSpKiJIIy_H_
...
namespace transport{
    ...
    class BypassProcessor : public ProcessorIf
    {
    public:
    BypassProcessor(std::function<void(uint64_t conn_id)> callback)
        : callback_(callback){}
